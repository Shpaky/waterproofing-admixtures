...
| 4 | Продукты: D5 и D5 Aqua Stop | ✅ | `9625f44`; D5 по TDS/SDS 2026-09-10; Aqua Stop по черновику TDS 2026-09-11, ждёт утверждённых документов ⛔ |
...
| 8 | Документы и сертификаты | ✅ | `ed2fd66`; TDS и SDS D5 на en/ru опубликованы в `public/docs`, остальное ⛔ |
| 9 | FAQ | ✅ | `9e9c492`, details/summary, FAQPage JSON-LD |
| 10 | Футер и мобильная CTA-панель | ✅ | Секция «Контакты» удалена 2026-09-08 по решению заказчика: контакты живут на родительском сайте. Organization JSON-LD в футере, конверсия через кнопки tel/WhatsApp |
...
- 🔄 Документы D5 (TDS, SDS на en/ru) опубликованы; фото, документы Aqua Stop и сертификаты ⛔.
...
## Визуальный язык
- 2026-09-11: второй сигнальный акцент `signal-*` и бетонная фактура на трёх полосах (hero, сравнение, футер). Решение и токены: `docs/design/color-and-texture.md`, кадры до/после в `docs/design/`.
