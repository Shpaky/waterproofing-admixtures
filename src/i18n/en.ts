export const en = {
  ...
  contacts: {
    eyebrow: 'Contacts',
    title: 'Talk to an engineer, not a bot',
    lead: 'Send the volume of concrete or a photo of the leak and get a recommendation with a price the same working day.',
    phone: 'Phone',
    whatsapp: 'WhatsApp',
    telegram: 'Telegram',
    email: 'E-mail',
  ...
  footer: {
    ...
    languages: 'Languages',
    contacts: 'Contacts',
    note: 'Product specifications are preliminary until confirmed in the technical datasheet.',
  },
